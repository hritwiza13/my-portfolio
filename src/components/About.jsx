...
const About = () => {
  ...
  const skills = {
    ...
    'Database Management': {
      items: ['SQL', 'MongoDB', 'MySQL', 'Firebase', 'PostgreSQL'],
      icon: 'https://cdn-icons-png.flaticon.com/512/4248/4248443.png'
    },
    'Development Tools & DevOps': {
      items: ['Git', 'Docker', 'Kubernetes', 'CI/CD', 'AWS', 'Azure', 'Jenkins'],
      icon: 'https://cdn-icons-png.flaticon.com/512/5969/5969059.png'
    },
    'AI/ML & Data Science': {
      items: ['Deep Learning', 'Computer Vision', 'NLP', 'Power BI', 'Tableau', 'TensorFlow', 'PyTorch'],
      icon: 'https://cdn-icons-png.flaticon.com/512/2103/2103633.png'
    }
  };
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="max-w-4xl mx-auto backdrop-blur-sm bg-gray-800/30 rounded-2xl p-8 shadow-2xl border border-gray-700/50">
          <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
            ...
            >
              Software Engineer with expertise in Python, Java, and full-stack development. 
              Passionate about building scalable applications and implementing AI/ML solutions. 
              Experienced in system architecture, cloud computing, and DevOps practices. 
              Strong background in data science and analytics with a focus on delivering 
              innovative solutions. Currently pursuing B.Tech in Computer Science & Engineering 
