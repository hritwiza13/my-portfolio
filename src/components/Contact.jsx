          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:erhritwizagupta13@gmail.com" className="text-blue-600 hover:text-blue-800">
                ...
                <div className="mt-8">
                  <h4 className="text-xl font-semibold mb-4 text-gray-800">Connect with me</h4>
